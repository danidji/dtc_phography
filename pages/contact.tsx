            ...
            <ContactWrapper className="contact_wrapper">
                <ContactHeader className="contact_header">
                    <div className="image_item" style={{width: "100%", height: "100%", position: "relative"}}>
                        <Image src="/assets/images/contact/contact_image1.jpeg" layout="fill" objectFit="cover" />
                    </div>
                    <div className="image_item" style={{width: "100%", height: "100%", position: "relative"}}>
                        <Image src="/assets/images/contact/contact_image2.jpg" layout="fill" objectFit="cover" />
                    </div>
                </ContactHeader>

                <h1 style={{color: color.secondary}}>Contact</h1>

                <StyledP color={color.secondary}>
                    Si vous aimez mon travail et que vous souhaitez que je vous aide à réaliser un de vos projets, vous pouvez me joindre via ce
